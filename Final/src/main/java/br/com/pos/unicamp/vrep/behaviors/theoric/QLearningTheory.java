package br.com.pos.unicamp.vrep.behaviors.theoric;
...
/**
** Class test for understood QLearning - Theory
**/
public class QLearningTheory {
	...
	public static void main(String args[]) throws IOException {
		QLearningTheory ql = new QLearningTheory();
