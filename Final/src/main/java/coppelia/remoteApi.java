...
public class remoteApi {
    ...
    public static final int sim_message_eventcallback_refreshdialogs = 293; /* aux[0]=keepGoing degree (0=light, 1=medium, 2=full) */
    ...
    /* particle objects: */
    /* following are mutually exclusive: */
    public static final int sim_particle_points1 = 0;           /* 6 values per point (pt1 and pt2. Pt1 is initialize position, pt2-pt1 is the initial velocity vector). Point is 1 pixel big. Only appearance is a point, internally handled as a perfect sphere */
    ...
    public native int simxGetObjectHandle(int clientID,
                                          final String objectName,
                                          IntW handle,
                                          int operationMode);

    public native int simxGetJointPosition(int clientID,
                                           int jointHandle,
                                           FloatW position,
                                           int operationMode);

    public native int simxSetJointPosition(int clientID,
                                           int jointHandle,
                                           float position,
                                           int operationMode);

    public native int simxGetObjectPosition(int clientID,
                                            int objectHandle,
                                            int relativeToObjectHandle,
                                            FloatWA position,
                                            int operationMode);

    public native int simxSetObjectPosition(int clientID,
                                            int objectHandle,
                                            int relativeToObjectHandle,
                                            final FloatWA position,
                                            int operationMode);

    public native int simxGetVisionSensorImage(int clientID,
                                               int sensorHandle,
                                               IntWA resolution,
                                               CharWA image,
                                               int options,
    ...
    public native int simxSetVisionSensorImage(int clientID,
                                               int sensorHandle,
                                               CharWA image,
                                               int bufferSize,
                                               int options,
    ...
    public native int simxGetJointMatrix(int clientID,
                                         int jointHandle,
                                         FloatWA matrix,
                                         int operationMode);

    public native int simxSetSphericalJointMatrix(int clientID,
                                                  int jointHandle,
                                                  FloatWA matrix,
                                                  int operationMode);

    public native int simxSetJointTargetVelocity(int clientID,
                                                 int jointHandle,
                                                 float targetVelocity,
                                                 int operationMode);

    public native int simxSetJointTargetPosition(int clientID,
                                                 int jointHandle,
                                                 float targetPosition,
                                                 int operationMode);

    public native int simxJointGetForce(int clientID,
                                        int jointHandle,
                                        FloatW force,
                                        int operationMode);

    public native int simxGetJointForce(int clientID,
                                        int jointHandle,
                                        FloatW force,
                                        int operationMode);

    public native int simxSetJointForce(int clientID,
                                        int jointHandle,
                                        float force,
                                        int operationMode);

    public native int simxReadForceSensor(int clientID,
                                          int forceSensorHandle,
                                          IntW state,
                                          FloatWA forceVector,
                                          FloatWA torqueVector,
                                          int operationMode);

    public native int simxBreakForceSensor(int clientID,
                                           int forceSensorHandle,
                                           int operationMode);

    public native int simxReadVisionSensor(int clientID,
                                           int sensorHandle,
                                           BoolW detectionState,
                                           FloatWAA auxValues,
                                           int operationMode);

    public native int simxGetObjectFloatParameter(int clientID,
                                                  int objectHandle,
                                                  int parameterID,
                                                  FloatW parameterValue,
                                                  int operationMode);

    public native int simxSetObjectFloatParameter(int clientID,
                                                  int objectHandle,
                                                  int parameterID,
                                                  float parameterValue,
                                                  int operationMode);

    public native int simxGetObjectIntParameter(int clientID,
                                                int objectHandle,
                                                int parameterID,
                                                IntW parameterValue,
                                                int operationMode);

    public native int simxSetObjectIntParameter(int clientID,
                                                int objectHandle,
                                                int parameterID,
                                                int parameterValue,
                                                int operationMode);

    public native int simxGetModelProperty(int clientID,
                                           int objectHandle,
                                           IntW prop,
                                           int operationMode);

    public native int simxSetModelProperty(int clientID,
                                           int objectHandle,
                                           int prop,
                                           int operationMode);

    public native int simxGetVisionSensorDepthBuffer(int clientID,
                                                     int sensorHandle,
                                                     IntWA resolution,
                                                     FloatWA buffer,
                                                     int operationMode);

    public native int simxGetObjectChild(int clientID,
                                         int parentObjectHandle,
                                         int childIndex,
                                         IntW childObjectHandle,
                                         int operationMode);

    public native int simxGetObjectParent(int clientID,
                                          int childObjectHandle,
                                          IntW parentObjectHandle,
                                          int operationMode);

    public native int simxStartSimulation(int clientID,
                                          int operationMode);

    public native int simxPauseSimulation(int clientID,
                                          int operationMode);

    public native int simxStopSimulation(int clientID,
                                         int operationMode);

    public native int simxGetUISlider(int clientID,
                                      int uiHandle,
                                      int uiButtonID,
                                      IntW position,
                                      int operationMode);

    public native int simxSetUISlider(int clientID,
                                      int uiHandle,
                                      int uiButtonID,
                                      int position,
                                      int operationMode);

    public native int simxGetUIEventButton(int clientID,
                                           int uiHandle,
                                           IntW uiEventButtonID,
                                           IntWA auxValues,
                                           int operationMode);

    public native int simxGetUIButtonProperty(int clientID,
                                              int uiHandle,
                                              int uiButtonID,
                                              IntW prop,
                                              int operationMode);

    public native int simxSetUIButtonProperty(int clientID,
                                              int uiHandle,
                                              int uiButtonID,
                                              int prop,
                                              int operationMode);

    public native int simxAuxiliaryConsoleClose(int clientID,
                                                int consoleHandle,
                                                int operationMode);

    public native int simxAuxiliaryConsoleShow(int clientID,
                                               int consoleHandle,
                                               boolean showState,
                                               int operationMode);

    public native int simxGetObjectOrientation(int clientID,
                                               int objectHandle,
                                               int relativeToObjectHandle,
                                               FloatWA eulerAngles,
                                               int operationMode);

    public native int simxSetObjectParent(int clientID,
                                          int objectHandle,
                                          int parentObject,
                                          boolean keepInPlace,
                                          int operationMode);

    public native int simxGetArrayParameter(int clientID,
                                            int paramIdentifier,
                                            FloatWA paramValues,
                                            int operationMode);

    public native int simxSetArrayParameter(int clientID,
                                            int paramIdentifier,
                                            FloatWA paramValues,
                                            int operationMode);

    public native int simxGetIntegerParameter(int clientID,
                                              int paramIdentifier,
                                              IntW paramValue,
                                              int operationMode);

    public native int simxSetIntegerParameter(int clientID,
                                              int paramIdentifier,
                                              int paramValue,
                                              int operationMode);

    public native int simxGetBooleanParameter(int clientID,
                                              int paramIdentifier,
                                              BoolW paramValue,
                                              int operationMode);

    public native int simxGetDialogResult(int clientID,
                                          int dialogHandle,
                                          IntW result,
                                          int operationMode);

    public native int simxSetFloatingParameter(int clientID,
                                               int paramIdentifier,
                                               float paramValue,
                                               int operationMode);

    public native int simxRemoveObject(int clientID,
                                       int objectHandle,
                                       int operationMode);

    public native int simxRemoveModel(int clientID,
                                      int objectHandle,
                                      int operationMode);

    public native int simxRemoveUI(int clientID,
                                   int uiHandle,
                                   int operationMode);

    public native int simxCloseScene(int clientID,
                                     int operationMode);

    public native int simxEndDialog(int clientID,
                                    int dialogHandle,
                                    int operationMode);

    public native int simxReadDistance(int clientID,
                                       int distanceObjectHandle,
                                       FloatW minimumDistance,
                                       int operationMode);

    public native int simxGetFloatingParameter(int clientID,
                                               int paramIdentifier,
                                               FloatW paramValue,
                                               int operationMode);

    public native int simxSetObjectOrientation(int clientID,
                                               int objectHandle,
                                               int relativeToObjectHandle,
                                               FloatWA eulerAngles,
                                               int operationMode);

    public native int simxReadProximitySensor(int clientID,
                                              int sensorHandle,
                                              BoolW detectionState,
                                              FloatWA detectedPoint,
                                              IntW detectedObjectHandle,
                                              FloatWA detectedSurfaceNormalVector,
                                              int operationMode);

    public native int simxLoadModel(int clientID,
                                    final String modelPathAndName,
                                    int options,
                                    IntW baseHandle,
                                    int operationMode);

    public native int simxLoadUI(int clientID,
                                 final String uiPathAndName,
                                 int options,
                                 IntWA uiHandles,
                                 int operationMode);

    public native int simxLoadScene(int clientID,
                                    final String scenePathAndName,
                                    int options,
                                    int operationMode);

    public native int simxGetUIHandle(int clientID,
                                      final String uiName,
                                      IntW handle,
                                      int operationMode);

    public native int simxAddStatusbarMessage(int clientID,
                                              final String message,
                                              int operationMode);

    public native int simxAuxiliaryConsoleOpen(int clientID,
                                               final String title,
                                               int maxLines,
                                               int mode,
                                               IntWA position,
                                               IntWA size,
                                               FloatWA textColor,
                                               FloatWA backgroundColor,
                                               IntW consoleHandle,
                                               int operationMode);

    public native int simxAuxiliaryConsolePrint(int clientID,
                                                int consoleHandle,
                                                final String txt,
                                                int operationMode);

    public native int simxSetUIButtonLabel(int clientID,
                                           int uiHandle,
                                           int uiButtonID,
                                           final String upStateLabel,
                                           final String downStateLabel,
                                           int operationMode);

    public native int simxGetLastErrors(int clientID,
                                        StringWA errorStrings,
                                        int operationMode);

    public native int simxSetBooleanParameter(int clientID,
                                              int paramIdentifier,
                                              boolean paramValue,
                                              int operationMode);

    public native int simxGetStringParameter(int clientID,
                                             int paramIdentifier,
                                             StringW paramValue,
                                             int operationMode);

    public native int simxGetCollisionHandle(int clientID,
                                             final String collisionObjectName,
                                             IntW handle,
                                             int operationMode);

    public native int simxGetDistanceHandle(int clientID,
                                            final String distanceObjectName,
                                            IntW handle,
                                            int operationMode);

    public native int simxGetCollectionHandle(int clientID,
                                              final String collectionName,
                                              IntW handle,
                                              int operationMode);

    public native int simxReadCollision(int clientID,
                                        int collisionObjectHandle,
                                        BoolW collisionState,
                                        int operationMode);

    public native int simxGetObjects(int clientID,
                                     int objectType,
                                     IntWA objectHandles,
                                     int operationMode);

    public native int simxDisplayDialog(int clientID,
                                        final String titleText,
                                        final String mainText,
                                        int dialogType,
                                        final String initialText,
                                        FloatWA titleColors,
                                        FloatWA dialogColors,
                                        IntW dialogHandle,
                                        IntW uiHandle,
                                        int operationMode);

    public native int simxGetDialogInput(int clientID,
                                         int dialogHandle,
                                         StringW inputText,
                                         int operationMode);

    public native int simxCopyPasteObjects(int clientID,
                                           IntWA objectHandles,
                                           IntWA newObjectHandles,
                                           int operationMode);

    public native int simxGetObjectSelection(int clientID,
                                             IntWA objectHandles,
                                             int operationMode);

    public native int simxSetObjectSelection(int clientID,
                                             IntWA objectHandles,
                                             int operationMode);

    public native int simxClearFloatSignal(int clientID,
                                           final String signalName,
                                           int operationMode);

    public native int simxClearStringSignal(int clientID,
                                            final String signalName,
                                            int operationMode);

    public native int simxClearIntegerSignal(int clientID,
                                             final String signalName,
                                             int operationMode);

    public native int simxGetFloatSignal(int clientID,
                                         final String signalName,
                                         FloatW signalValue,
                                         int operationMode);

    public native int simxGetIntegerSignal(int clientID,
                                           final String signalName,
                                           IntW signalValue,
                                           int operationMode);

    public native int simxGetStringSignal(int clientID,
                                          final String signalName,
                                          CharWA signalValue,
                                          int operationMode);

    public native int simxGetAndClearStringSignal(int clientID,
                                                  final String signalName,
                                                  CharWA signalValue,
                                                  int operationMode);

    public native int simxReadStringStream(int clientID,
                                           final String signalName,
                                           CharWA signalValue,
                                           int operationMode);

    public native int simxSetFloatSignal(int clientID,
                                         final String signalName,
                                         float signalValue,
                                         int operationMode);

    public native int simxSetIntegerSignal(int clientID,
                                           final String signalName,
                                           int signalValue,
                                           int operationMode);

    public native int simxSetStringSignal(int clientID,
                                          final String signalName,
                                          final CharWA signalValue,
                                          int operationMode);

    public native int simxAppendStringSignal(int clientID,
                                             final String signalName,
                                             final String signalValue,
                                             int operationMode);

    public native int simxWriteStringStream(int clientID,
                                            final String signalName,
                                            final CharWA signalValue,
                                            int operationMode);

    public native int simxGetPingTime(int clientID,
                                      IntW pingTime);
    ...
    public native int simxSynchronous(int clientID,
                                      boolean enable);

    public native int simxPauseCommunication(int clientID,
                                             boolean enable);

    public native int simxGetInMessageInfo(int clientID,
                                           int infoType,
                                           IntW info);

    public native int simxGetOutMessageInfo(int clientID,
                                            int infoType,
                                            IntW info);

    public native int simxTransferFile(int clientID,
                                       final String filePathAndName,
                                       final String fileName_serverSide,
                                       int timeOut,
                                       int operationMode);

    public native int simxEraseFile(int clientID,
                                    final String fileName_serverSide,
                                    int operationMode);

    public native int simxCreateDummy(int clientID,
                                      float size,
                                      CharWA color,
                                      IntW dummyHandle,
                                      int operationMode);

    public native int simxQuery(int clientID,
                                final String signalName,
                                final CharWA signalValue,
                                final String retSignalName,
                                CharWA retSignalValue,
                                int timeOutInMs);

    public native int simxGetObjectGroupData(int clientID,
                                             int objectType,
                                             int dataType,
                                             IntWA handles,
                                             IntWA intData,
    ...
    public native int simxGetObjectVelocity(int clientID,
                                            int objectHandle,
                                            FloatWA linearVelocity,
                                            FloatWA angularVelocity,
                                            int operationMode);

    public native int simxCallScriptFunction(int clientID,
                                             final String scriptDescription,
                                             int options,
                                             final String functionName,
                                             final IntWA inInts,
                                             final FloatWA inFloats,
                                             final StringWA inStrings,
                                             final CharWA inBuffer,
                                             IntWA outInts,
                                             FloatWA outFloats,
                                             StringWA outStrings,
                                             CharWA outBuffer,
